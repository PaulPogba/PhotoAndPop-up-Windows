...
//    }
    [[UIApplication sharedApplication] setStatusBarHidden:NO withAnimation:UIStatusBarAnimationNone];//隐藏状态栏
...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount imagesCount:(NSInteger)imagesCount delegate:(id<TZImagePickerControllerDelegate>)delegate {
