...
- (void)viewDidLoad {
    ...
    [backButton setImage:imageNamed(@"icon_navigation_back") forState:UIControlStateNormal];
...
- (void)configBottomToolBar {
    ...
    [_previewButton setTitleColor:[UIColor blackColor] forState:UIControlStateDisabled];
    ...
    _okButton.frame = CGRectMake(self.view.tz_width - 80 - 12,MARGIN_8, 80,33);
