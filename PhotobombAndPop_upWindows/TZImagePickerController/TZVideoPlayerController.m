...
- (void)configPlayButton {
    ...
    [_playButton setImage:imageNamed(@"MMVideoPreviewPlay") forState:UIControlStateNormal];
    [_playButton setImage:imageNamed(@"MMVideoPreviewPlayHL") forState:UIControlStateHighlighted];
