...
- (void) setIconInTopWithTitleSpacing:(CGFloat)titleSpacing imageSpacing:(CGFloat) imageSpacing
{
    CGFloat img_W = self.imageView.frame.size.width;
    CGFloat img_H = self.imageView.frame.size.height;
    CGFloat tit_W = self.titleLabel.frame.size.width;
    ...
    self.titleEdgeInsets = (UIEdgeInsets){
        .top    =   (tit_H / 2 + titleSpacing / 2),
        .left   = - (img_W / 2),
        .bottom = - (tit_H / 2 + titleSpacing / 2),
        .right  =   (img_W / 2),
    };
    
    self.imageEdgeInsets = (UIEdgeInsets){
        .top    = - (img_H / 2 + imageSpacing / 2),
        .left   =   (tit_W / 2),
        .bottom =   (img_H / 2 + imageSpacing / 2),
        .right  = - (tit_W / 2),
    };
    TQEasyIconInfo *iconInfo = [[TQEasyIconInfo alloc] initWithSpacing:titleSpacing iconDirection:TQEasyIconInTop];
